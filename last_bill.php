...
{
		$msg='<div class="alert alert-success" style="font-size:17px;padding:20px;text-align:center;"><strong> SUCCESS-! </strong> Fetching Your Last Transaction Details </div>';
...
?>
  <script>
        function Redirect() {
             window.location="last_bill1.php?id=<?=$test?>";
            }
       setTimeout('Redirect()', 2000);
</script>
<?php } }?>
