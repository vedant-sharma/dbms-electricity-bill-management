...
{
		$msg='<div class="alert alert-success" style="font-size:17px;padding:20px;text-align:center;"><strong> SUCCESS-! </strong> Fetching Your Status of payments </div>';
...
?>
  <script>
        function Redirect() {
             window.location="status1.php?id=<?=$test?>";
            }
       setTimeout('Redirect()', 2000);
</script>
<?php } }?>
